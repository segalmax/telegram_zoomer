...
def get_prompt(style):
    ...
    if style == 'left':
        ...
        prompt = (
            ...
            "КРИТИЧЕСКИ ВАЖНО: Пост должен быть СТРОГО НЕ БОЛЕЕ 180 СЛОВ в ОДНОМ АБЗАЦЕ! Считай слова! "
            "НЕ РАЗБИВАЙ НА НЕСКОЛЬКО АБЗАЦЕВ - пиши сплошным текстом из 3-4 предложений. "
            "Только если статья исключительно длинная, можешь сделать максимум 2 коротких абзаца. "
            "Выбери самое важное и ударное. Никаких подзаголовков, разделов, длинных цитат. "
            "Лучше сказать меньше, но точно. ОБЯЗАТЕЛЬНО уложись в 180 слов одним абзацем!\n\n"
            
            "ВАЖНО: Избегай повторения фраз и конструкций из предыдущих переводов. Ты видишь примеры предыдущих переводов — "
